...
import com.mile.mile_navigation_engine.MileNavigationEnginePlugin2.Companion.CREATED
import com.mile.mile_navigation_engine.MileNavigationEnginePlugin2.Companion.DESTROYED
import com.mile.mile_navigation_engine.MileNavigationEnginePlugin2.Companion.PAUSED
import com.mile.mile_navigation_engine.MileNavigationEnginePlugin2.Companion.RESUMED
import com.mile.mile_navigation_engine.MileNavigationEnginePlugin2.Companion.STARTED
import com.mile.mile_navigation_engine.MileNavigationEnginePlugin2.Companion.STOPPED
...
class MileNavigationEngine2 : Application.ActivityLifecycleCallbacks,
    ...
    constructor(id: Int, context: Context, messenger: BinaryMessenger, activity: FragmentActivity, route: String, gpsColor: String, accessToken: String, mode: String, state: AtomicInteger) {
        ...
        this.callback = MileNavigationEngine2.ComponentActivityLocationCallback(this)
    ...
    private fun bindBottomSheetWith(poi: POI){
         ...
         */
        private class ComponentActivityLocationCallback internal constructor(activity: MileNavigationEngine2) : LocationEngineCallback<LocationEngineResult> {

            private val activityWeakReference: WeakReference<MileNavigationEngine2>
