...
class IntroductionTreasureHunt : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_introduction_treasure_hunt, container, false)
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(listenerInteraction: OnFragmentInteraction) : IntroductionTreasureHunt{
            var fragment = IntroductionTreasureHunt()
