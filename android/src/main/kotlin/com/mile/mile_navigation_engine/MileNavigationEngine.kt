...
class MileNavigationEngine : Application.ActivityLifecycleCallbacks,
    ...
    private fun bindBottomSheetWith(poi: POI){
         ...
         */
        private class ComponentActivityLocationCallback internal constructor(activity: MileNavigationEngine) : LocationEngineCallback<LocationEngineResult> {

            private val activityWeakReference: WeakReference<MileNavigationEngine>
